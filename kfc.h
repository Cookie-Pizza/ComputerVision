...
public:
    ...
    KImageColor&    BoxFiltering(double &dSigma);
    KImageColor&    MedianFiltered(int nWindow);
};
...
//---------------------------------------------------------------------------
typedef struct tagKCIRCLEHOUGH_INFO
{
    int nLeft;
    int nRight;
    int nTop;
...
class KCircleHough : public KObject, public KCircle
{
